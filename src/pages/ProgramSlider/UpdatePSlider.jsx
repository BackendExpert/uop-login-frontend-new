    ...
    return (
        <div className='mt-4'>
            <div className="flex">
                ...
                <div className="pl-4">
                    <h1 className="text-[#560606] text-xl pt-1 font-semibold uppercase">Update Programme Notice {id}</h1>
                </div>
            </div>
            <div className="mt-4">
            ...
            <div className="mt-8">
                ...
                <div className="bg-white p-4 rounded-md shadow-xl mt-8">
                    ...
                    <div className="">
                        {imagedata ? imagedata.pdesc : "Loading..."}
                    </div>
                    <div className="">
